...
### 招聘广告（发布日期：20231024）
美团配送商流策略组正在招聘选品定价算法工程师，职级L6-L7，有意者可随时与我联系。

商流策略组服务于美团外卖、美团闪购、美团买药、美团跑腿、拼好饭等业务线的十余个业务场景，专注于在线零售领域的算法研究与应用。我们通过机器学习、因果推断、运筹优化、强化学习、机器视觉、NLP、时空数据挖掘，为千万商家寻找商机，为平台运营提供智能化方案，为用户提高交易和履约体验，从而促进平台和生态的供给繁荣和用户增长。

这是一支快速成长中的学习型团队。在创造业务价值的同时，我们不断输出学术成果，在ICML、KDD、SIGSPATIAL、Transportation Research Part E等国际会议和期刊上发表数篇学术论文。团队学习氛围浓厚，每年组织五十余场分享交流，互相学习和启发。真诚邀请海内外相关方向的优秀人才加入我们，在这里成长并贡献才智。


<hr>

### 工作经历
#### 2017.09至今，美团-外卖配送，L9
**2021.08至今，商流策略组负责人**：负责配送网络规划、配送费定价和爆单。核心业绩是用户App的差异化履约产品（超区送、顺风餐、优享送、优惠送）、外卖配送选品定价系统（高维因果推断、大规模组合优化求解）。

**2017.09-2021.08，地图策略组负责人**：负责骑手轨迹、交付点、AOI、骑行规划。核心业绩是骑手App的末端指引系统（交付点挖掘、AOI生产、出入口挖掘、骑步禁通行模式挖掘、末端算路）、骑手轨迹仓库（轨迹分段、地图匹配）。

晋升2次，入职P3-1，2018晋升P3-2，2020晋升P3-3（2021职级体系迭代为L9）。


#### 2014.07-2017.09，阿里巴巴-高德地图，P6
**机器学习研发部算法工程师**。利用机器学习算法处理时空轨迹数据，改善用户驾车规划的体验。核心业绩是高德大数据交通报告、未来路况预测、封路挖掘、道路通行代价学习。

晋升2次，校招入职T1.3，2015晋升T2（合并为阿里职级P5），2016晋升P6。

<hr>

### 教育经历
#### 2011.09-2014.07，清华大学，管理科学与工程，硕士；德国亚琛工业大学，生产系统工程，硕士
获留德全额奖学金、三菱重工奖学金、清华之友—德语奖学金。

#### 2007.09-2011.07，清华大学，工业工程，本科
获国家奖学金、清华之友—渠玉芝奖学金和清华大学优良毕业生。
...
### 专业技能
- 大数据：熟练使用Hadoop、Hive、Spark处理海量GPS数据；熟练使用Storm、Flink进行实时轨迹流处理。
- 机器学习：熟练使用TensorFlow进行神经网络开发；熟练使用Numpy和scikit-learn完成常规机器学习模型研发。
- 空间计算：熟练使用R语言完成数据分析与前端工具开发；熟悉shp、WKT、GeoJSON等常见的空间数据格式，熟练使用GEOS、JTS、Shapely、GeoServer进行空间计算。
- 运筹优化：熟悉Dijkstra、A*等最短路算法；熟悉派单、TSP、VRP等调度算法；熟悉分支定界、拉格朗日松弛、动态规划等精确求解算法；熟悉Gurobi、SCIP开发。
- 外语：英语六级，德语C1。
