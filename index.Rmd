...
我是陈水平，硕士毕业于德国亚琛工大，2014年4月加入阿里，从事算法工程师的工作，主要职责是基于高德地图驾车导航的GPS轨迹，将大数据工具、机器学习算法、数据可视化技术三者结合，提供改善用户出行体验的解决方案；2017年9月加入美团外卖，负责时空数据挖掘。
...
### 工作经历
+ 2017.09至今，美团外卖-配送事业部-算法策略组，P3-1
+ 2014.04-2017.09，阿里移动事业群-高德地图-出行业务中心-机器学习研发部，P6
