...
+ b1, i1, i2, i4, i8, u1, u2, u4, u8, f2, f4, f8, c8, c16, a<n> (representing bytes, ints, unsigned ints, floats, complex and fixed length strings of specified byte lengths)
...
persontype = [('name', 'S32'), ('age', 'i'), ('weight', 'f')]
